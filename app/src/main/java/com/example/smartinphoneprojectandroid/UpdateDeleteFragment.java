...
public class UpdateDeleteFragment extends Fragment {
    private AdapterUpdateHP adapterHP;
     ...
     * @return A new instance of fragment UpdateDeleteFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UpdateDeleteFragment newInstance(String param1, String param2) {
        UpdateDeleteFragment fragment = new UpdateDeleteFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<HandphoneModel>>() {
            ...
            public void onResponse(Call<List<HandphoneModel>> call, Response<List<HandphoneModel>> response) {
                ...
                adapterHP = new AdapterUpdateHP(list);
