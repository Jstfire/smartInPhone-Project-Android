 ...
 * Use the {@link ListhpFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ListhpFragment extends Fragment {
    private AdapterListHP adapterHP;
    private RecyclerView hpRV;
    private List<HandphoneModel> list;
     ...
     * @return A new instance of fragment ListhpFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ListhpFragment newInstance(String param1, String param2) {
        ListhpFragment fragment = new ListhpFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_listhp, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<HandphoneModel>>() {
            ...
            public void onResponse(Call<List<HandphoneModel>> call, Response<List<HandphoneModel>> response) {
                ...
                hpRV = view.findViewById(R.id.hp_rv);
            ...
            public void onFailure(Call<List<HandphoneModel>> call, Throwable t) {
                Toast.makeText(view.getContext(), "Gagal Menampilkan List!", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//    }
//
//    public void loadHP(List<HandphoneModel> list){
//        ((MainActivity) getActivity()).loadMyList(list);
//    }
}